...
<div class="container-fluid one contact">
...
<div class="container two contact">
  <div class="row">
  ...
  <div class="row">
    ...
    <div class="col-lg-6 text-center">
      ...
      <p><strong>The White Lion</strong><br />
		31 Main Road<br />
		Weston<br />
		Nr. Crewe<br />
		Cheshire<br />
...
<div class="container three contact">
  <div class="row">
...
<div class="container four contact">
  <div class="row">
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"></div>
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 text-center"> <img class="break" src="<?php echo BASE_URL; ?>static/images/break.png" /> </div>
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"></div>
